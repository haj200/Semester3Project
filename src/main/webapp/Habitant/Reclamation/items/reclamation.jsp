...
<body>
    ...
    <div class="container">
        <div class="card">
            <h5 class="card-title">Réclamation de ${reclamation.habitant.nom} ${reclamation.habitant.prenom}</h5>
            <p class="card-text"><strong>Message :</strong> ${reclamation.message}</p>
            <p class="card-text"><strong>Réponse :</strong> ${reclamation.reponse}</p>
        </div>
